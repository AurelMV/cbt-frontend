...
export default function Page() {
  ...
  const alumnoSchema = z.object({
    ...
    email: z.union([
      z.string().regex(EMAIL_REGEX, "Email inválido"),
      z.literal(""),
    ]),
    anoCulminado: z.coerce
      .number()
      .int()
      .min(1900)
      .max(2100)
  ...
  const rows = useMemo<InscripcionListItem[]>(
    () => inscQ.data?.items ?? [],
    [inscQ.data]
  );
    ...
    try {
      ...
      if (data.pagoNow && data.pago) {
        ...
        const file: File | null | undefined =
          (data.pago as { archivo?: File | null }).archivo ?? null;
      ...
      const msg =
        e instanceof Error ? e.message : "No se pudo crear la inscripción";
      toast.error(msg);
    }
  });
      ...
      <Card>
            ...
            <SheetContent side="right" className="w-full sm:max-w-xl p-0">
              ...
              <form onSubmit={onSubmitCrear} className="flex h-full flex-col">
                <div className="flex-1 overflow-y-auto p-4 space-y-6">
                  <Tabs
                    value={wizard}
                    onValueChange={(v) => setWizard(v as typeof wizard)}
                    className="w-full"
                  >
                            ...
                            <FieldLabel htmlFor="crearAlumno">
                              <div className="flex items-center gap-2">
                                <input
                                  id="crearAlumno"
                                  type="checkbox"
                                  {...createForm.register("crearAlumno")}
                                />
                          ...
                          {!createForm.watch("crearAlumno") && (
                            <Field>
                              ...
                              <FieldContent>
                                ...
                                <FieldError
                                  errors={[
                                    createForm.formState.errors.alumnoSel,
                                  ]}
                                />
                              </FieldContent>
                            </Field>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <Field>
                                ...
                                <FieldContent>
                                  ...
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.alumno
                                        ?.nombreAlumno,
                                    ]}
                                  />
                                </FieldContent>
                              ...
                              <Field>
                                <FieldLabel htmlFor="alAPaterno">
                                  Apellido paterno
                                </FieldLabel>
                                <FieldContent>
                                  <Input
                                    id="alAPaterno"
                                    {...createForm.register("alumno.aPaterno")}
                                  />
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.alumno
                              ...
                              <Field>
                                <FieldLabel htmlFor="alAMaterno">
                                  Apellido materno
                                </FieldLabel>
                                <FieldContent>
                                  <Input
                                    id="alAMaterno"
                                    {...createForm.register("alumno.aMaterno")}
                                  />
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.alumno
                              ...
                              <Field>
                                ...
                                <FieldContent>
                                  ...
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.alumno?.sexo,
                                    ]}
                                  />
                                </FieldContent>
                              </Field>
                              ...
                              <Field>
                                <FieldLabel htmlFor="alNacimiento">
                                  Fecha de nacimiento
                                </FieldLabel>
                                <FieldContent>
                                  <Input
                              ...
                              <Field className="md:col-span-2">
                                <FieldLabel htmlFor="alDireccion">
                                  Dirección
                                </FieldLabel>
                                <FieldContent>
                                  <Input
                                    id="alDireccion"
                                    {...createForm.register("alumno.Direccion")}
                                  />
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.alumno
                              ...
                              <Field>
                                ...
                                <FieldContent>
                                  <Input
                                    id="alEmail"
                                    type="email"
                                    {...createForm.register("alumno.email")}
                                  />
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.alumno?.email,
                                    ]}
                                  />
                                </FieldContent>
                              </Field>
                    ...
                    <TabsContent value="insc" className="mt-0">
                      <FieldSet>
                        ...
                        <FieldGroup>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <Field>
                              <FieldLabel htmlFor="programaSel">
                                Programa
                              </FieldLabel>
                              <FieldContent>
                                <Controller
                                  ...
                                  render={({ field }) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        <SelectTrigger id="programaSel">
                                          <SelectValue
                                            placeholder={
                                              programasQ.isLoading
                                                ? "Cargando…"
                                                : "Seleccione"
                                            }
                                          />
                                ...
                                <FieldError
                                  errors={[
                                    createForm.formState.errors.insc
                                      ?.idPrograma,
                                  ]}
                                />
                              </FieldContent>
                            ...
                            <Field>
                              ...
                              <FieldContent>
                                ...
                                <FieldError
                                  errors={[
                                    createForm.formState.errors.insc?.idCiclo,
                                  ]}
                                />
                              </FieldContent>
                            </Field>
                            <Field>
                              ...
                              <FieldContent>
                                ...
                                <FieldError
                                  errors={[
                                    createForm.formState.errors.insc?.idClase,
                                  ]}
                                />
                              </FieldContent>
                            </Field>
                            <Field>
                              <FieldLabel htmlFor="codigoInsc">
                                Código
                              </FieldLabel>
                              <FieldContent>
                                <Input
                                  id="codigoInsc"
                                  {...createForm.register("insc.Codigo")}
                                />
                                <FieldError
                                  errors={[
                                    createForm.formState.errors.insc?.Codigo,
                                  ]}
                                />
                              </FieldContent>
                            </Field>
                            <Field>
                              ...
                              <FieldContent>
                                <Input
                                  id="turnoInsc"
                                  {...createForm.register("insc.turno")}
                                />
                                <FieldError
                                  errors={[
                                    createForm.formState.errors.insc?.turno,
                                  ]}
                                />
                              </FieldContent>
                            </Field>
                            <Field>
                              ...
                              <FieldContent>
                                <Input
                                  id="fechaInsc"
                                  type="date"
                                  {...createForm.register("insc.fecha")}
                                />
                                <FieldError
                                  errors={[
                                    createForm.formState.errors.insc?.fecha,
                                  ]}
                                />
                              </FieldContent>
                            </Field>
                      ...
                      <FieldSet>
                        ...
                        <FieldGroup>
                          ...
                          {createForm.watch("pagoNow") && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <Field>
                                <FieldLabel htmlFor="nroVoucher">
                                  Comprobante
                                </FieldLabel>
                                <FieldContent>
                                  <Input
                                    id="nroVoucher"
                                    {...createForm.register("pago.nroVoucher")}
                                  />
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.pago
                                        ?.nroVoucher,
                                    ]}
                                  />
                                </FieldContent>
                              ...
                              <Field>
                                ...
                                <FieldContent>
                                  <Input
                                    id="fechaPago"
                                    type="date"
                                    {...createForm.register("pago.fecha")}
                                  />
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.pago?.fecha,
                                    ]}
                                  />
                                </FieldContent>
                              </Field>
                              <Field>
                                <FieldLabel htmlFor="montoPago">
                                  Monto
                                </FieldLabel>
                                <FieldContent>
                                  <Input
                                    ...
                                    min={0}
                                    step="0.01"
                                    {...createForm.register("pago.monto", {
                                      valueAsNumber: true,
                                    })}
                                  />
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.pago?.monto,
                                    ]}
                                  />
                                </FieldContent>
                              </Field>
                              <Field>
                                <FieldLabel htmlFor="medioPago">
                                  Medio
                                </FieldLabel>
                                <FieldContent>
                                  <Input
                                    id="medioPago"
                                    {...createForm.register("pago.medioPago")}
                                  />
                                  <FieldError
                                    errors={[
                                      createForm.formState.errors.pago
                              ...
                              <Field className="md:col-span-2">
                                <FieldLabel htmlFor="archivoPago">
                ...
                <div className="border-t bg-background p-3 flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      type="button"
                      variant="outline"
                      disabled={wizard === "alumno"}
                      onClick={() =>
                        setWizard(wizard === "pago" ? "insc" : "alumno")
                      }
                    >
                      Atrás
                    </Button>
                    {wizard === "pago" ? (
                      <Button type="submit" disabled={createInsc.isPending}>
                        {createInsc.isPending ? "Creando…" : "Crear"}
                      </Button>
                    ) : (
                      <Button
                        type="button"
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
            <div>
              <label className="text-sm" htmlFor="cicloList">
                Ciclo
              </label>
              <Select value={ciclo} onValueChange={(v) => setCiclo(v)}>
                <SelectTrigger id="cicloList">
                  <SelectValue
                    placeholder={
                      ciclosQ.isLoading ? "Cargando…" : "Selecciona un ciclo"
                    }
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              <label className="text-sm" htmlFor="progList">
                Programa
              </label>
              <Select
                value={programa}
                onValueChange={(v) => setPrograma(v === "all" ? "" : v)}
              >
                <SelectTrigger id="progList">
                  <SelectValue
                    placeholder={programasQ.isLoading ? "Cargando…" : "Todos"}
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              <label className="text-sm" htmlFor="claseList">
                Clase
              </label>
              <Select
                value={clase || "all"}
                onValueChange={(v) => setClase(v === "all" ? "" : v)}
              >
                <SelectTrigger id="claseList">
                  <SelectValue
                    placeholder={clasesQ.isLoading ? "Cargando…" : "Todas"}
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              <label className="text-sm" htmlFor="buscarInsc">
                Buscar backend (Código / estado / tipo)
              </label>
              <Input
                id="buscarInsc"
                value={q}
                ...
                placeholder="Ej. COD-001 pendiente inscripcion"
              />
            </div>
            <div className="md:col-span-2 flex flex-col gap-1">
              <label className="text-sm" htmlFor="dniLookup">
                Buscar inscripción por DNI + Ciclo
              </label>
              <div className="flex gap-2">
                <Input
                  id="dniLookup"
                  value={dniLookup}
                  onChange={(e) => setDniLookup(e.target.value)}
                ...
                <Button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      const res = await mod.buscarInscripcion(
                        dniLookup,
                        Number(ciclo),
                        { silentError: true }
                      );
                      toast.success(
                        `Inscripción encontrada: Código ${
                          res.Codigo ?? "—"
                        } Alumno ${res.nombreAlumno} ${res.aPaterno}`
                      );
                      ...
                      toast.error(
                        "No se encontró inscripción para ese DNI y ciclo"
                      );
                    } finally {
                ...
                >
                  {lookupLoading ? "Buscando…" : "Buscar DNI"}
                </Button>
              </div>
            </div>
          </div>
                  ...
                  {pageItems.map((r) => (
                    <TableRow key={r.id} data-insc-row>
                      ...
                      <TableCell>
                        <Sheet
                          open={edit?.id === r.id}
                          onOpenChange={(open) => setEdit(open ? r : null)}
                        >
                          <SheetTrigger asChild>
              ...
              <div className="flex items-center justify-between pt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-sm">
                    {totalPaginas === 0 ? 0 : page + 1} / {totalPaginas || 1}
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                    ...
                    onClick={() =>
                      setPage((p) =>
                        Math.min(Math.max(0, totalPaginas - 1), p + 1)
                      )
                    }
                  >
                    Siguiente
...
function EditInscripcionForm({
  value,
  onCancel,
  onSaved,
}: {
  readonly value: InscripcionListItem;
